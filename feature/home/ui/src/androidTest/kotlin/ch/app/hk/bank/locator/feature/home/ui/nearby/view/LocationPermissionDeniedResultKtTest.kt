...
@HiltAndroidTest
class LocationPermissionDeniedResultKtTest {
    @get:Rule(order = 0)
    ...
    @Test
    fun clickActionButton_ShouldInvoke_OnPermissionGranted() {
        ...
        composeTestRule.setContent {
            CompositionLocalProvider(LocalActivityResultRegistryOwner provides registryOwner) {
                LocationPermissionDeniedResult(onPermissionGranted = onPermissionGranted)
            }
        }

        composeTestRule
            .onNodeWithText(getResourceString(R.string.home_button_app_settings))
            .performClick()
    ...
    @Test
    fun clickActionButton_ShouldNotInvoke_OnPermissionGranted() {
        ...
        verify { onPermissionGranted wasNot Called }
    }
}
