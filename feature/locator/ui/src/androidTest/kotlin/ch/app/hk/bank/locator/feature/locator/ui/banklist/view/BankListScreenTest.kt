...
class BankListScreenTest {
    ...
    fun testBankListScreenShouldShowTitle() {
        ...
        composeTestRule
            .onNodeWithText(getResourceString(R.string.locator_title_bank_list))
            .assertIsDisplayed()
    }
    ...
    fun testBankListScreenShouldShowBankList() {
        ...
        composeTestRule
            .onAllNodesWithContentDescription(getResourceString(R.string.locator_content_description_bank_item))
            .assertCountEquals(2)
    }
}
