package ch.app.hk.bank.locator.feature.locator.ui.banklist.view
...
import ch.app.hk.bank.locator.feature.locator.ui.banklist.viewmodel.BankListViewModel
import ch.app.hk.bank.locator.feature.locator.ui.banklist.viewmodel.BankListViewModelImpl
...
private fun BankListItem(item: String) {
    Column(
        modifier =
            Modifier
                .contentDescription(stringResource(id = R.string.locator_content_description_bank_item))
                .fillMaxWidth()
                .wrapContentHeight()
